...
imovel.disponibilidade=disponibilidade.id WHERE disponibilidade=2 AND proprietario=?';
...
imovel.disponibilidade=disponibilidade.id WHERE disponibilidade=1 AND proprietario=?';
